...
export let employees = [
    ...
    new Employee(107, "Krzysztof Jankowski", new GuardCard(107, "Krzysztof Jankowski")),
    new Employee(230, "Agnieszka Wojcik", new OperatorCard(230, "Agnieszka Wojcik")),
    new Employee(412, "Pawel Nowicki", new OperatorCard(412, "Pawel Nowicki")),
    new Employee(351, "Katarzyna Kaczmarek", new OperatorCard(351, "Katarzyna Kaczmarek")),
