import { transactionZone, externalZone, operationalZone, securityZone, } from "../Zones/allZones.js";
import { DoorFactory } from "../Doors/DoorFactory.js";
const doorConfigs = [
    {
        doorId: 0,
        sourceZoneId: 4,
...
export const allTestDoors = doorConfigs.map((config) => DoorFactory.createDoor(config.doorId, config.sourceZoneId, config.targetZone, config.description));
